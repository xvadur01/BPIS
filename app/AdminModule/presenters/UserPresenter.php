...
class UserPresenter extends BasePresenter {
	...
	function __construct(\App\Model\UserManager $userManager, \App\Model\EventManager $eventManager, \App\Model\TermManager $termManager, \App\Model\BorrowingManager $borrowingManager, \App\Model\RecordManager $recordManager) {
	...
	protected function createComponentNewUserEventsForm() {
		...
		$dates = $form->addDynamic('events', function (Container $time) use ($removeEvent) {
