...
list($_b, $_g, $_l) = $template->initialize('4080836814', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb56bed4b789_scripts')) { function _lb56bed4b789_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbcc2ec0b010_content')) { function _lbcc2ec0b010_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<div class="row">
	<div class="s12 m6 col input-field">
	...
	<div class="s12 m6 col input-field">
		<?php echo $_form["pocet_upozorneni"]->getControl() ?>

		<?php if ($_label = $_form["pocet_upozorneni"]->getLabel()) echo $_label  ?>
