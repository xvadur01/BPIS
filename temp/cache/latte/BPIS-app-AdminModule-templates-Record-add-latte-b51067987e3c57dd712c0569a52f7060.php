...
list($_b, $_g, $_l) = $template->initialize('5902317695', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block headerH1
//
if (!function_exists($_b->blocks['headerH1'][] = '_lb05aee70f5a_headerH1')) { function _lb05aee70f5a_headerH1($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>Nový záznam<?php
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lba2101e79fd_scripts')) { function _lba2101e79fd_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb7b25138861_content')) { function _lb7b25138861_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
