...
list($_b, $_g, $_l) = $template->initialize('3572419825', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block headerH1
//
if (!function_exists($_b->blocks['headerH1'][] = '_lbba1a10a887_headerH1')) { function _lbba1a10a887_headerH1($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>Úprava stránky<?php
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbd4a94c1631_scripts')) { function _lbd4a94c1631_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbd6ff06fc2c_content')) { function _lbd6ff06fc2c_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
