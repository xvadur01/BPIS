...
list($_b, $_g, $_l) = $template->initialize('1660442090', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb313e732ec9_scripts')) { function _lb313e732ec9_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbb4298a3b93_content')) { function _lbb4298a3b93_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
