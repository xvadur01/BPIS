...
list($_b, $_g, $_l) = $template->initialize('7264418734', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block headerH1
//
if (!function_exists($_b->blocks['headerH1'][] = '_lb46c4964245_headerH1')) { function _lb46c4964245_headerH1($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>Úprava stránky<?php
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb7887f7c98e_scripts')) { function _lb7887f7c98e_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbe104aa17bc_content')) { function _lbe104aa17bc_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
