...
list($_b, $_g, $_l) = $template->initialize('5016605632', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbeddb718ddf_scripts')) { function _lbeddb718ddf_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb14054cb955_content')) { function _lb14054cb955_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
