...
list($_b, $_g, $_l) = $template->initialize('5447926255', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block headerH1
//
if (!function_exists($_b->blocks['headerH1'][] = '_lb118ef4cad3_headerH1')) { function _lb118ef4cad3_headerH1($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbaf706a7858_scripts')) { function _lbaf706a7858_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbfda9f7bd4e_content')) { function _lbfda9f7bd4e_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
