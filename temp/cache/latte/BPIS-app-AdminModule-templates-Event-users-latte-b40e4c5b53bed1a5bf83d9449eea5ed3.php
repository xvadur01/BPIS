...
list($_b, $_g, $_l) = $template->initialize('4847216859', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block headerH1
//
if (!function_exists($_b->blocks['headerH1'][] = '_lb75d55ee533_headerH1')) { function _lb75d55ee533_headerH1($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbca1998fe63_scripts')) { function _lbca1998fe63_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb0bf0b9883a_content')) { function _lb0bf0b9883a_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
