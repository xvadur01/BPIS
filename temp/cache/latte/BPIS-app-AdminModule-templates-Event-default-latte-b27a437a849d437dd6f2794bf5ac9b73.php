...
list($_b, $_g, $_l) = $template->initialize('1253250121', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block headerH1
//
if (!function_exists($_b->blocks['headerH1'][] = '_lb6ae4d04421_headerH1')) { function _lb6ae4d04421_headerH1($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb25ae40a17b_content')) { function _lb25ae40a17b_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="row">
	<div class="col s9">
...
<?php } ?>
			<a href="<?php echo Latte\Runtime\Filters::escapeHtml($_presenter->link("Event:detail", array($event->id)), ENT_COMPAT) ?>" title="Detail události" class="btn-floating waves-effect waves-light orange"><i class="mdi-action-subject"></i></a>
		</td>
	</tr>
<?php $iterations++; } ?>
</table><?php
