...
list($_b, $_g, $_l) = $template->initialize('3406241815', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block headerH1
//
if (!function_exists($_b->blocks['headerH1'][] = '_lb0d3dba2f84_headerH1')) { function _lb0d3dba2f84_headerH1($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb0c37173784_content')) { function _lb0c37173784_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="event row">
