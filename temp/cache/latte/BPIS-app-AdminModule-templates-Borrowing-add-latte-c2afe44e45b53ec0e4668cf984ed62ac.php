...
list($_b, $_g, $_l) = $template->initialize('2655632889', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb5c2453f64d_content')) { function _lb5c2453f64d_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
