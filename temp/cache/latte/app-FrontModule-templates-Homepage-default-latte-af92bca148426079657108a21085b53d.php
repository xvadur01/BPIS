...
list($_b, $_g, $_l) = $template->initialize('0703336792', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbe24ef41f6b_content')) { function _lbe24ef41f6b_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
<?php call_user_func(reset($_b->blocks['title']), $_b, get_defined_vars())  ?>
</div>

<div id="content">
<?php $_l->tmp = $_control->getComponent("testForm"); if ($_l->tmp instanceof Nette\Application\UI\IRenderable) $_l->tmp->redrawControl(NULL, FALSE); $_l->tmp->render() ?>
	<?php echo Latte\Runtime\Filters::escapeHtml($test->popis, ENT_NOQUOTES) ?>

	<input type="text" class="datepicker">
	<input type="hidden" name="_submit">
	<p>

      <label for="test8"><input type="checkbox" id="test8" disabled="disabled">Brown</label>
		</p>
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb6b80744e4c_title')) { function _lb6b80744e4c_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbb347678903_scripts')) { function _lbb347678903_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb67aee390c6_head')) { function _lb67aee390c6_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
