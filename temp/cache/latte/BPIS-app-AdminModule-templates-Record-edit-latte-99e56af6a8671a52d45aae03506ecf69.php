...
list($_b, $_g, $_l) = $template->initialize('6874762872', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block headerH1
//
if (!function_exists($_b->blocks['headerH1'][] = '_lbcf37a7864a_headerH1')) { function _lbcf37a7864a_headerH1($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>Upravit záznam<?php
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb917a05149a_scripts')) { function _lb917a05149a_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb4b6bd556fe_content')) { function _lb4b6bd556fe_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
