...
list($_b, $_g, $_l) = $template->initialize('8236752763', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbb59838fc94_scripts')) { function _lbb59838fc94_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb97d653d599_content')) { function _lb97d653d599_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
