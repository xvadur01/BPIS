...
list($_b, $_g, $_l) = $template->initialize('8446776161', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb909796b346_scripts')) { function _lb909796b346_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbf8a86592a0_content')) { function _lbf8a86592a0_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
