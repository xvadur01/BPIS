...
list($_b, $_g, $_l) = $template->initialize('7134202056', 'html')
;
...
"><h4 class="timeline-title"><?php echo Latte\Runtime\Filters::escapeHtml($record->nazev, ENT_NOQUOTES) ?></h4></a>
				<p>
					...
					<br>
					<small class="text-muted">Předpokládané datum ukončení:</small> <i class="glyphicon glyphicon-time"><?php echo Latte\Runtime\Filters::escapeHtml($template->date($record->datum_splneni, '%d.%m.%Y'), ENT_NOQUOTES) ?></i>
				</p>
			</div>
